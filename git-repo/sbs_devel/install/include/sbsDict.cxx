...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Decoder::SBSDecodeF1TDCLowResModule*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Decoder::SBSDecodeF1TDCLowResModule", ::Decoder::SBSDecodeF1TDCLowResModule::Class_Version(), "SBSDecodeF1TDCModule.h", 82,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Decoder::SBSDecodeF1TDCHighResModule*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Decoder::SBSDecodeF1TDCHighResModule", ::Decoder::SBSDecodeF1TDCHighResModule::Class_Version(), "SBSDecodeF1TDCModule.h", 95,
...
namespace ROOT {
   static void delete_SBSGEPHeepCoinModule(void *p);
   static void deleteArray_SBSGEPHeepCoinModule(void *p);
   static void destruct_SBSGEPHeepCoinModule(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::SBSGEPHeepCoinModule*)
   {
      ::SBSGEPHeepCoinModule *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::SBSGEPHeepCoinModule >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("SBSGEPHeepCoinModule", ::SBSGEPHeepCoinModule::Class_Version(), "SBSGEPHeepCoinModule.h", 18,
                  typeid(::SBSGEPHeepCoinModule), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::SBSGEPHeepCoinModule::Dictionary, isa_proxy, 4,
                  sizeof(::SBSGEPHeepCoinModule) );
      instance.SetDelete(&delete_SBSGEPHeepCoinModule);
      instance.SetDeleteArray(&deleteArray_SBSGEPHeepCoinModule);
      instance.SetDestructor(&destruct_SBSGEPHeepCoinModule);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::SBSGEPHeepCoinModule*)
   {
      return GenerateInitInstanceLocal(static_cast<::SBSGEPHeepCoinModule*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::SBSGEPHeepCoinModule*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
atomic_TClass_ptr SBSGEPHeepCoinModule::fgIsA(nullptr);  // static to hold class pointer

//______________________________________________________________________________
const char *SBSGEPHeepCoinModule::Class_Name()
{
   return "SBSGEPHeepCoinModule";
}

//______________________________________________________________________________
const char *SBSGEPHeepCoinModule::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::SBSGEPHeepCoinModule*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int SBSGEPHeepCoinModule::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::SBSGEPHeepCoinModule*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *SBSGEPHeepCoinModule::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::SBSGEPHeepCoinModule*)nullptr)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *SBSGEPHeepCoinModule::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::SBSGEPHeepCoinModule*)nullptr)->GetClass(); }
   return fgIsA;
}
...
//______________________________________________________________________________
void SBSGEPHeepCoinModule::Streamer(TBuffer &R__b)
{
   // Stream an object of class SBSGEPHeepCoinModule.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(SBSGEPHeepCoinModule::Class(),this);
   } else {
      R__b.WriteClassBuffer(SBSGEPHeepCoinModule::Class(),this);
   }
}
...
namespace ROOT {
   // Wrapper around operator delete
   static void delete_SBSGEPHeepCoinModule(void *p) {
      delete (static_cast<::SBSGEPHeepCoinModule*>(p));
   }
   static void deleteArray_SBSGEPHeepCoinModule(void *p) {
      delete [] (static_cast<::SBSGEPHeepCoinModule*>(p));
   }
   static void destruct_SBSGEPHeepCoinModule(void *p) {
      typedef ::SBSGEPHeepCoinModule current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::SBSGEPHeepCoinModule
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<vector<vector<double> > >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<vector<vector<double> > >", -2, "vector", 383,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<vector<SBSSimDecoder::gemstripinfo> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<vector<SBSSimDecoder::gemstripinfo> >", -2, "vector", 383,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("vector<vector<SBSSimDecoder::gemstripinfo> >","std::__1::vector<std::__1::vector<SBSSimDecoder::gemstripinfo, std::__1::allocator<SBSSimDecoder::gemstripinfo>>, std::__1::allocator<std::__1::vector<SBSSimDecoder::gemstripinfo, std::__1::allocator<SBSSimDecoder::gemstripinfo>>>>"));
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<SBSTimingHodoscopePMT*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<SBSTimingHodoscopePMT*>", -2, "vector", 383,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("vector<SBSTimingHodoscopePMT*>","std::__1::vector<SBSTimingHodoscopePMT*, std::__1::allocator<SBSTimingHodoscopePMT*>>"));
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<SBSTimingHodoscopeCluster*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<SBSTimingHodoscopeCluster*>", -2, "vector", 383,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("vector<SBSTimingHodoscopeCluster*>","std::__1::vector<SBSTimingHodoscopeCluster*, std::__1::allocator<SBSTimingHodoscopeCluster*>>"));
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<SBSTimingHodoscopeBar*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<SBSTimingHodoscopeBar*>", -2, "vector", 383,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("vector<SBSTimingHodoscopeBar*>","std::__1::vector<SBSTimingHodoscopeBar*, std::__1::allocator<SBSTimingHodoscopeBar*>>"));
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<SBSSimDecoder::gemstripinfo>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<SBSSimDecoder::gemstripinfo>", -2, "vector", 383,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("vector<SBSSimDecoder::gemstripinfo>","std::__1::vector<SBSSimDecoder::gemstripinfo, std::__1::allocator<SBSSimDecoder::gemstripinfo>>"));
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<SBSSimDecoder::detchaninfo>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<SBSSimDecoder::detchaninfo>", -2, "vector", 383,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("vector<SBSSimDecoder::detchaninfo>","std::__1::vector<SBSSimDecoder::detchaninfo, std::__1::allocator<SBSSimDecoder::detchaninfo>>"));
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<SBSElement*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<SBSElement*>", -2, "vector", 383,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("vector<SBSElement*>","std::__1::vector<SBSElement*, std::__1::allocator<SBSElement*>>"));
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const set<Exp_t>*)
   {
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("set<Exp_t>","std::__1::set<Exp_t, std::__1::less<Exp_t>, std::__1::allocator<Exp_t>>"));
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<string,vector<vector<SBSSimDecoder::gemstripinfo> > >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<string,vector<vector<SBSSimDecoder::gemstripinfo> > >", -2, "map", 1018,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("map<string,vector<vector<SBSSimDecoder::gemstripinfo> > >","std::__1::map<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>, std::__1::vector<std::__1::vector<SBSSimDecoder::gemstripinfo, std::__1::allocator<SBSSimDecoder::gemstripinfo>>, std::__1::allocator<std::__1::vector<SBSSimDecoder::gemstripinfo, std::__1::allocator<SBSSimDecoder::gemstripinfo>>>>, std::__1::less<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>>, std::__1::allocator<std::__1::pair<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> const, std::__1::vector<std::__1::vector<SBSSimDecoder::gemstripinfo, std::__1::allocator<SBSSimDecoder::gemstripinfo>>, std::__1::allocator<std::__1::vector<SBSSimDecoder::gemstripinfo, std::__1::allocator<SBSSimDecoder::gemstripinfo>>>>>>>"));
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<string,vector<SBSSimDecoder::detchaninfo> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<string,vector<SBSSimDecoder::detchaninfo> >", -2, "map", 1018,
      ...
      instance.AdoptAlternate(::ROOT::AddClassAlternate("map<string,vector<SBSSimDecoder::detchaninfo> >","std::__1::map<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>, std::__1::vector<SBSSimDecoder::detchaninfo, std::__1::allocator<SBSSimDecoder::detchaninfo>>, std::__1::less<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>>, std::__1::allocator<std::__1::pair<std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> const, std::__1::vector<SBSSimDecoder::detchaninfo, std::__1::allocator<SBSSimDecoder::detchaninfo>>>>>"));
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   int RecordReadRules_libsbs() {
      return 0;
   }
   static int _R__UNIQUE_DICT_(ReadRules_libsbs) = RecordReadRules_libsbs();R__UseDummy(_R__UNIQUE_DICT_(ReadRules_libsbs));
} // namespace ROOT
namespace {
...
"SBSGEPHeepCoinModule.h",
"DebugDef.h",
"Helper.h",
nullptr
    };
    static const char* includePaths[] = {
"/Users/brash/CDet_replay/git-repo/sbs_devel/SBS-offline",
"/usr/local/Cellar/root/6.36.00/include/root",
"/Users/brash/local/analyzer/include",
"/Users/brash/CDet_replay/git-repo/sbs_devel/SBS-offline",
"/usr/local/Cellar/root/6.36.00/include/root",
"/Users/brash/CDet_replay/git-repo/sbs_devel/build/",
nullptr
    };
...
class __attribute__((annotate("$clingAutoload$SBSGEPHeepCoinModule.h")))  SBSGEPHeepCoinModule;
)DICTFWDDCLS";
...
"SBSGEPHeepCoinModule", payloadCode, "@",
